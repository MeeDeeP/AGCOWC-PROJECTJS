...
<script>
    function confirmLogout() {
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5 col-md-1 col-lg-3"></div>
                         ...
                         <div class="card-body bg-muted">
                            ...
                            <p class="card-text"><?php echo htmlspecialchars($row['user_post']); ?></p>
                                ...
                                <form action="post_edit_query.php" method="POST">
                                    <button type="submit" name="edit" class="btn btn-success" value="<?php echo $row['post_id']; ?>">Edit</a>
                                </form>
                                <button onclick="confirmDelete('<?php echo $row['post_id']; ?>')" class="btn btn-warning justify-content-between">Delete</button>
