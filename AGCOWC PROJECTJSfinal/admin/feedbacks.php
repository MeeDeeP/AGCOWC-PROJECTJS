...
if (!empty($search)) {
    $sql = $conn->prepare("SELECT * FROM feedback WHERE user_email LIKE :search OR user_feedback LIKE :search OR user_name LIKE :search");
                    ...
                    <div class="col-sm-10 col-md-10 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body bg-muted">
                                <h5 class="card-title"><?php echo $row['user_email']; ?></h5>
