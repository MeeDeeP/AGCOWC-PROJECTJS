            ...
            <div class="card px-4 py-4 mx-2">
                <form action="feedback_query.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control my-2" name="name" placeholder="Name" value="<?php echo $fetch['user_username'] ;?>">
                        <input type="hidden" class="form-control my-2" name="email" placeholder="email" value="<?php echo $fetch['user_email'] ;?>">
                            <div id="feedback">
